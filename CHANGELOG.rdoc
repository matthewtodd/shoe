...
* Shoe.install_tasks auto-detects gemspec.
* Remove dependency on launchy.
* Generate a basic Gemfile, delegating to the gemspec.
* Don't .gitignore .rvmrc.
* Use optparse-defaults gem for command line options.
* Be more specific about dependency versions.
* Use bundler's gemspec option.
