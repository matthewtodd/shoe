...
== Getting Started with Bundler[http://github.com/carlhuda/bundler]
...
Open a sub-shell configured for the bundler environment:
...
And then <tt>require 'shoe'</tt> and add a <tt>Shoe.tie</tt> clause to your +Rakefile+:
 ...
 Shoe.tie('name', 'version', 'description') do |spec|
 end
