...
I've just become aware of https://github.com/erikh/rubygems-test, which changes
the landscape for Shoe::Tasks::Test. Once I've had the chance to further check it
out, Shoe will move to embrace it.
