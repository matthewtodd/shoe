...
Shoe is a library of Rake tasks that honor your gemspec.

Hoe[http://seattlerb.rubyforge.org/hoe] and
Jeweler[http://github.com/technicalpickles/jeweler] (currently) generate the
gemspec for you, but it's often better {just to let it be its own
thing}[http://yehudakatz.com/2010/04/02/using-gemspecs-as-intended/].
...
line <tt>gem 'foo', :path => '.'</tt> to your <tt>Gemfile</tt> if you have one.
